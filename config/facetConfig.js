...
export const facetConfig = {
    ...
    language: { title: 'Language', search: true, info: true, type: 'wiki' },
    subject: { title: 'Subjects', search: true, info: true, type: 'wiki' },
    contributor: { title: 'Contributors', search: true, info: true, type: 'wiki' },
    geo: { title: 'Geo Locations', search: true, info: true, type: 'wiki' },
